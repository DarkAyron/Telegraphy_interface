...
#ifndef DRAGONUSB_USB_DESC_H_
#define DRAGONUSB_USB_DESC_H_

extern const uint8_t USB_dev_desc[];
extern const uint8_t USB_cfg_desc[];
extern const uint8_t USB_dev_qualifier_desc[];
extern const uint8_t USB_lang_str_desc[];
extern const uint8_t USB_vendor_str_desc[];
extern const uint8_t USB_prod_str_desc[];
extern const uint8_t USB_serial_str_desc[];
extern const uint8_t USB488_capabilities_response[];

#endif /* DRAGONUSB_USB_DESC_H_ */
